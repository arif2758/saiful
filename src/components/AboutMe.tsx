...
export default function AboutMe() {
  ...
  return (
    ...
    >
      ...
      {/* Profile Section */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 items-start mb-12 rounded-lg shadow-lg p-4 sm:p-8 bg-[linear-gradient(to_right,_rgba(99,_102,_241,_0.05),_rgba(20,_184,_166,_0.05))] border border-[#031919] overflow-hidden">
